...
<div class="container border rounded p-4 mb-2 mt-2">
    <div class="row">
        ...
        <form action="" method="post" class="col-lg-3 col-md-6 col-sm-6 col-6">
...
<div class="container border rounded p-4 mb-2 mt-2">
    <h1 class="font-weight-light text-center p-4 text-white">Full of General Knowledge Books</h1>
    <div class="row">
